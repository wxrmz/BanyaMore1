...
test('administrator can open yesterday through 11:59:59 Vladivostok time', () => {
  ...
  assert.deepEqual(getAdminDailyReportAccess('2026-09-13', now), {
    ...
    closesAt: '2026-09-14T02:00:00.000Z',
    today: '2026-09-14',
    yesterday: '2026-09-13',
  });
});

test('administrator loses yesterday exactly at noon and cannot open the day before yesterday', () => {
