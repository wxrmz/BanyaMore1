...
export const metadata: Metadata = {
  title: "Баня Море | Оздоровительный комплекс на берегу моря во Владивостоке",
  description:
    "Премиальный банный комплекс на берегу Японского моря: оздоровительный комплекс, приватный отдых, морской воздух и панорамные виды.",
  keywords: [
  ...
  openGraph: {
    title: "Баня Море | Оздоровительный комплекс на берегу моря",
    description:
